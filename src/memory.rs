//! Memory management — page table initialization and frame allocation.
//!
//! Sets up virtual memory with 4-level paging on x86_64.
//! The bootloader maps all physical memory at a configurable offset,
//! which we use to access and modify page tables.
...
impl BootInfoFrameAllocator {
    ...
    /// All frames marked as `USABLE` must be truly unused.
